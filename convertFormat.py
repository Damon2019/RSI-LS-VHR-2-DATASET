...
class voc2coco:
    def __init__(self, devkit_path=None, year=None):
        ...
        assert 'VOCdevkit' in devkit_path, 'VOC address not exits: {}'.format(devkit_path)
...
def demo():
    # Convert pascal address is './VOC2007/VOCdevkit/VOC2007/ImageSets/Main/trainval.txt'
